...
namespace Jammy.Core.CPU.Musashi.MC68040
{
	public class Musashi68040CPU : ICPU, IMusashiCPU, IStatePersister
	{
		...
		public Musashi68040CPU(IInterrupt interrupt, IMemoryMapper memoryMapper,
			IBreakpointCollection breakpoints, ITracer tracer, ILogger<Musashi68040CPU> logger)
		{
			...
			logger.LogTrace("Starting Musashi C 68040 CPU");
