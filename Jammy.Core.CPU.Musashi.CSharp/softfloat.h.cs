...
public static partial class M68KCPU
{
	...
	*----------------------------------------------------------------------------*/
	...
	static floatx80 packFloatx80(flag zSign, int32 zExp, bits64 zSig)
	{
		floatx80 z;
	...
	*----------------------------------------------------------------------------*/
	...
	/* int floatx80_fsin(floatx80 out a);
	int floatx80_fcos(floatx80 out a);
	int floatx80_ftan(floatx80 out a); */
	...
	*----------------------------------------------------------------------------*/
	...
	| significand.
	*----------------------------------------------------------------------------*/
	static float128 packFloat128(int zSign, int32 zExp, bits64 zSig0, bits64 zSig1)
	{
		return packFloat128(zSign!=0, zExp, zSig0, zSig1);
	}
