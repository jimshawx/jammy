...
*/
static uint pmmu_translate_addr(uint addr_in)
{
	...
	if (Bool(m68ki_cpu.mmu_tc & 0x02000000) && Bool(m68ki_get_sr() & 0x2000))
	{
	...
	@is = (int)((m68ki_cpu.mmu_tc>>16) & 0xf);
	abits = (int)((m68ki_cpu.mmu_tc>>12)&0xf);
	bbits = (int)((m68ki_cpu.mmu_tc>>8)&0xf);
	cbits = (int)((m68ki_cpu.mmu_tc>>4)&0xf);
...
public static void m68881_mmu_ops()
{
	uint16 modes;
							...
							else
							{
							 	switch ((modes>>10) & 7)
								{
									case 0:	// translation control register
										...
										if (Bool(m68ki_cpu.mmu_tc & 0x80000000))
										{
