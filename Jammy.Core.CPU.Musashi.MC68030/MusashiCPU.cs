...
namespace Jammy.Core.CPU.Musashi.MC68030
{
	public class Musashi68030CPU : ICPU, IMusashiCPU, IStatePersister
	{
		...
		public Musashi68030CPU(IInterrupt interrupt, IMemoryMapper memoryMapper,
			IBreakpointCollection breakpoints, ITracer tracer, ILogger<Musashi68030CPU> logger)
		{
			...
			logger.LogTrace("Starting Musashi C 68030 CPU");
